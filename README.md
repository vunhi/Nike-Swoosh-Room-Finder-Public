# Nike Swoosh Room Finder
### 2017 PSU Capstone Project
...
1. Download the apk, import it to your Android device, and install the application. 

2. Using an Android development environment like Android Studio, Clone or Download the source code from this github repository and build the application and run it on your device or an appropriate emulator. 


## Online Simulations of the Application

### - [Swoosh Room Finder v2.0](https://appetize.io/app/r03jqpg9ggagqgybkk0gd10r2g?device=nexus5&scale=75&orientation=portrait&osVersion=7.1) 
...
This is a simulation using the Public release for a resolution of 1080 x 1920 xxhdpi. 
...
Note: there is a activity limit for these simulators on appetize.io. The link may not work due to reaching these limits. To run a simulation of the app you can download the desired apk in the apk directory and upload it yourself to appetize.io to test out the app. 
